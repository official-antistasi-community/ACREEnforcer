...
private _TS3ServerAddressDisplay = "38.133.154.60:9987";

// The message to show to the client
private _clientMessageDisplay = "Hello and welcome to Antistasi official server!\n\n
								If you want to play here, you must install the TSE addon and join our TeamSpeak server\n\n
								Our TS3 server address: %1\n\n
								Your TSE addon state: %2\n
								Your TSE TS3 plugin state: %3";
